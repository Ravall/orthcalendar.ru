...
*/
class Db_Gateway_SystemCities extends Zend_Db_Table_Abstract {
    protected $_name = 'mf_system_cities';
    ...
    protected $_referenceMap    = array(
        ...
        'Region' => array(
            ...
            'refTableClass'     => 'Db_Gateway_SystemRegions',
            'refColumns'        => array('region_id')
        ),
    );
}
?>